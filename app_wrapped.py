...
def main():
    ...
    if st.session_state.selected_year is None:
        ...
        # UPLOAD SECTION
        st.markdown("<h2 style='text-align: center; margin: 2rem 0; background: linear-gradient(135deg, #00d4ff 0%, #0099ff 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;'>Upload Your Data</h2>", unsafe_allow_html=True)
        ...
        with col2:
            if available_years:
                st.markdown("<h3 style='text-align: center; color: #aaa;'>Or view existing data:</h3>", unsafe_allow_html=True)
